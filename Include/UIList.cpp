...
void CListUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	{
	case 'h':
		if( _tcscmp(pstrName, _T("header")) == 0 ) {GetHeader()->SetVisible(_tcscmp(pstrValue, _T("hidden")) != 0);return ;}
		if( _tcscmp(pstrName, _T("headerbkimage")) == 0 ) {GetHeader()->SetBkImage(pstrValue);return ;}
		break;
	case 'i':
		{
			if(_tcslen(pstrName)<5)break;
			switch(pstrName[4])
			{
			case 'a':
				if( _tcscmp(pstrName, _T("itemalign")) == 0 ) {
				...
				else if( _tcscmp(pstrName, _T("itemaltbk")) == 0 ) {SetAlternateBk(_tcscmp(pstrValue, _T("true")) == 0);return ;}
				break;
			case 'b':
				...
				else if( _tcscmp(pstrName, _T("itembkimage")) == 0 ) {SetItemBkImage(pstrValue);return ;}
				break;
			case 'd':
				if( _tcscmp(pstrName, _T("itemdisabledtextcolor")) == 0 ) {
					if( *pstrValue == _T('#')) pstrValue = ::CharNext(pstrValue);
					LPTSTR pstr = NULL;
					DWORD clrColor = _tcstoul(pstrValue, &pstr, 16);
				...
				else if( _tcscmp(pstrName, _T("itemdisabledimage")) == 0 ) {SetDisabledItemImage(pstrValue);return ;}
				break;
			case 'e':
				if( _tcscmp(pstrName, _T("itemendellipsis")) == 0 ) {
					if( _tcscmp(pstrValue, _T("true")) == 0 ) m_ListInfo.uTextStyle |= DT_END_ELLIPSIS;
					else m_ListInfo.uTextStyle &= ~DT_END_ELLIPSIS;
					return ;
				}break;
			case 'f':
				if( _tcscmp(pstrName, _T("itemfont")) == 0 ) {m_ListInfo.nFont = _ttoi(pstrValue);return ;}
				break;
			case 'h':
				if( _tcscmp(pstrName, _T("itemhottextcolor")) == 0 ) {
					if( *pstrValue == _T('#')) pstrValue = ::CharNext(pstrValue);
					LPTSTR pstr = NULL;
					DWORD clrColor = _tcstoul(pstrValue, &pstr, 16);
				...
				else if( _tcscmp(pstrName, _T("itemhotimage")) == 0 ) {SetHotItemImage(pstrValue);return ;}
				break;
			case 'l':
				if( _tcscmp(pstrName, _T("itemlinecolor")) == 0 ) {
					if( *pstrValue == _T('#')) pstrValue = ::CharNext(pstrValue);
					LPTSTR pstr = NULL;
					DWORD clrColor = _tcstoul(pstrValue, &pstr, 16);
			...
			case 's':
				if( _tcscmp(pstrName, _T("itemselectedtextcolor")) == 0 ) {
					if( *pstrValue == _T('#')) pstrValue = ::CharNext(pstrValue);
					LPTSTR pstr = NULL;
					DWORD clrColor = _tcstoul(pstrValue, &pstr, 16);
				...
				else if( _tcscmp(pstrName, _T("itemselectedimage")) == 0 ) {SetSelectedItemImage(pstrValue);return ;}
				else
					if( _tcscmp(pstrName, _T("itemshowhtml")) == 0 ) {SetItemShowHtml(_tcscmp(pstrValue, _T("true")) == 0);return ;}
				break;
			case 't':
		...
		break;
	case 's':
		if( _tcscmp(pstrName, _T("scrollselect")) == 0 ) {SetScrollSelect(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	case 'm':
		if( _tcscmp(pstrName, _T("multiexpanding")) == 0 ) {SetMultiExpanding(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	}
...
void CListHeaderItemUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'a':
		...
		break;
	case 'd':
		if( _tcscmp(pstrName, _T("dragable")) == 0 ) {SetDragable(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	case 's':
		if( _tcscmp(pstrName, _T("sepwidth")) == 0 ) {SetSepWidth(_ttoi(pstrValue));return ;}
		else if( _tcscmp(pstrName, _T("showhtml")) == 0 ) {SetShowHtml(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		else if( _tcscmp(pstrName, _T("sepimage")) == 0 ) {SetSepImage(pstrValue);return ;}
		 break;
	case 'e':
	...
	case 'f':
		...
		else if( _tcscmp(pstrName, _T("focusedimage")) == 0 ) {SetFocusedImage(pstrValue);return ;}
		break;
	case 'h':
...
void CListElementUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	{
	case 's':
		if( _tcscmp(pstrName, _T("selected")) == 0 ) {Select();return ;}
		break;
	}
	CControlUI::SetAttribute(pstrName, pstrValue);
}
...
void CListLabelElementUI::DoPaint(HDC hDC, const RECT& rcPaint)
{
    ...
    DrawItemText(hDC, m_rcItem,&m_rcPaint);
}

void CListLabelElementUI::DrawItemText(HDC hDC, const RECT& rcItem,RECT* pPaintItem)
{
    if( m_sText.IsEmpty() ) return;
    ...
    if( pInfo->bShowHtml )
	{
        ...
        NULL, NULL, nLinks, DT_SINGLELINE | pInfo->uTextStyle,pPaintItem);
	}
    else
...
void CListContainerElementUI::DrawItemText(HDC hDC, const RECT& rcItem,RECT* pPaintItem)
{
    return;
}
