...
void CControlUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	{
	case 'b':
		  if( _tcscmp(pstrName, _T("bkcolor")) == 0 || _tcscmp(pstrName, _T("bkcolor1")) == 0 ) {
		  ...
		  else if( _tcscmp(pstrName, _T("bordersize")) == 0 ) {SetBorderSize(_ttoi(pstrValue)); return ;}
		  ...
		  else if( _tcscmp(pstrName, _T("bkimage")) == 0 ) {SetBkImage(pstrValue); return ;}
		break;
	case 'c':
		if( _tcscmp(pstrName, _T("colorhsl")) == 0 ) {SetColorHSL(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		 break;
	case 'e':
		if( _tcscmp(pstrName, _T("enabled")) == 0 ) {SetEnabled(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		break;
	case 'f':
		if( _tcscmp(pstrName, _T("focusbordercolor")) == 0 ) {
			if( *pstrValue == _T('#')) pstrValue = ::CharNext(pstrValue);
			LPTSTR pstr = NULL;
			DWORD clrColor = _tcstoul(pstrValue, &pstr, 16);
			SetFocusBorderColor(clrColor);
			 return ;
		}else if( _tcscmp(pstrName, _T("float")) == 0 ) {SetFloat(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		break;
	case 'h':
		if( _tcscmp(pstrName, _T("height")) == 0 ) {SetFixedHeight(_ttoi(pstrValue)); return ;}
		break;
	case 'k':
		if( _tcscmp(pstrName, _T("keyboard")) == 0 ) {SetKeyboardEnabled(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		break;
	case 'm':
		if( _tcscmp(pstrName, _T("minwidth")) == 0 ) {SetMinWidth(_ttoi(pstrValue)); return ;}
		else  if( _tcscmp(pstrName, _T("minheight")) == 0 ) {SetMinHeight(_ttoi(pstrValue)); return ;}
		else if( _tcscmp(pstrName, _T("maxwidth")) == 0 ) {SetMaxWidth(_ttoi(pstrValue)); return ;}
		else if( _tcscmp(pstrName, _T("maxheight")) == 0 ) {SetMaxHeight(_ttoi(pstrValue)); return ;}
		else if( _tcscmp(pstrName, _T("mouse")) == 0 ) {SetMouseEnabled(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		else if( _tcscmp(pstrName, _T("menu")) == 0 ) {SetContextMenuUsed(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		 break;
	case 'n':
		if( _tcscmp(pstrName, _T("name")) == 0 ) {SetName(pstrValue); return ;}
		 break;
	case 'p':
		...
		break;
	case 't':
		if( _tcscmp(pstrName, _T("text")) == 0 ) {SetText(pstrValue); return ;}
		else if( _tcscmp(pstrName, _T("tooltip")) == 0 ) {SetToolTip(pstrValue); return ;}
		break;
	case 'r':
		if( _tcscmp(pstrName, _T("relativepos")) == 0 ) {
			SIZE szMove,szZoom;
			LPTSTR pstr = NULL;
	...
	case 's':
		if( _tcscmp(pstrName, _T("shortcut")) == 0 ) {SetShortcut(pstrValue[0]); return ;}
		break;
	case 'u':
		if( _tcscmp(pstrName, _T("userdata")) == 0 ) {SetUserData(pstrValue); return ;}
		break;
		
	case 'w':
		if( _tcscmp(pstrName, _T("width")) == 0 ) {SetFixedWidth(_ttoi(pstrValue)); return ;}
		break;
	case 'v':
		if( _tcscmp(pstrName, _T("visible")) == 0 ) {SetVisible(_tcscmp(pstrValue, _T("true")) == 0); return ;}
		break;
	}
