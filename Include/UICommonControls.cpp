...
void CLabelUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'e':
		...
		break;
	case 'f':
		if( _tcscmp(pstrName, _T("font")) == 0 ) {SetFont(_ttoi(pstrValue));return ;}
		break;
	case 't':
		...
		break;
	case 's':
		if( _tcscmp(pstrName, _T("showhtml")) == 0 ) {SetShowHtml(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	}
...
void CButtonUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'n':
		...
		break;
	case 'p':
		if( _tcscmp(pstrName, _T("pushedimage")) == 0 ) {SetPushedImage(pstrValue);return ;}
...
void COptionUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	{
	case 'f':
		if( _tcscmp(pstrName, _T("foreimage")) == 0 ) {SetForeImage(pstrValue);return ;}
		break;
	case 'g':
		if( _tcscmp(pstrName, _T("group")) == 0 ) {SetGroup(pstrValue);return ;}
		 break;
	case 's':
		if( _tcscmp(pstrName, _T("selected")) == 0 ) {Selected(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		else if( _tcscmp(pstrName, _T("selectedimage")) == 0 ) {SetSelectedImage(pstrValue);return ;}
...
void CProgressUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'f':
		...
		break;
	case 'h':	
		if( _tcscmp(pstrName, _T("hor")) == 0 ) {SetHorizontal(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	case 'm':
		if( _tcscmp(pstrName, _T("min")) == 0 ) {SetMinValue(_ttoi(pstrValue));return ;}
		else if( _tcscmp(pstrName, _T("max")) == 0 ) {SetMaxValue(_ttoi(pstrValue));return ;}
		break;
	case 'v':
		if( _tcscmp(pstrName, _T("value")) == 0 ) {SetValue(_ttoi(pstrValue));return ;}
		break;
	}
	CLabelUI::SetAttribute(pstrName, pstrValue);
}
...
void CSliderUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	{
	case 't':
		if( _tcscmp(pstrName, _T("thumbimage")) == 0 ) {SetThumbImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("thumbhotimage")) == 0 ) {SetThumbHotImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("thumbpushedimage")) == 0 ) {SetThumbPushedImage(pstrValue);return ;}
...
void CEditUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'd':
		...
		break;
	case 'm':
		if( _tcscmp(pstrName, _T("maxchar")) == 0 ) {SetMaxChar(_ttoi(pstrValue));return ;}
		break;
	case 'n':
		if( _tcscmp(pstrName, _T("normalimage")) == 0 ) {SetNormalImage(pstrValue);return ;}
		...
		break;
	case 'p':
		if( _tcscmp(pstrName, _T("password")) == 0 ) {SetPasswordMode(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	case 'r':
...
void CScrollBarUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	case 'b':
		{
			if(_tcslen(pstrName)>2 &&pstrName[1]=='k')
			{
				if( _tcscmp(pstrName, _T("bknormalimage")) == 0 ) {SetBkNormalImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("bkhotimage")) == 0 ) {SetBkHotImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("bkpushedimage")) == 0 ) {SetBkPushedImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("bkdisabledimage")) == 0 ) {SetBkDisabledImage(pstrValue);return ;}
				break;
			}
			if(_tcslen(pstrName)<8)break;
			switch(pstrName[7])
			{
			case 'n':
				if( _tcscmp(pstrName, _T("button1normalimage")) == 0 ) {SetButton1NormalImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("button2normalimage")) == 0 ) {SetButton2NormalImage(pstrValue);return ;}
				break;
			case 'h':
				if( _tcscmp(pstrName, _T("button1hotimage")) == 0 ) {SetButton1HotImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("button2hotimage")) == 0 ) {SetButton2HotImage(pstrValue);return ;}
				break;
			case 'p':
				if( _tcscmp(pstrName, _T("button1pushedimage")) == 0 ) {SetButton1PushedImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("button2pushedimage")) == 0 ) {SetButton2PushedImage(pstrValue);return ;}
				break;
			case 'd':
				if( _tcscmp(pstrName, _T("button1disabledimage")) == 0 ) {SetButton1DisabledImage(pstrValue);return ;}
				else if( _tcscmp(pstrName, _T("button2disabledimage")) == 0 ) {SetButton2DisabledImage(pstrValue);return ;}
				break;
			}
		}break;
	case 't':
		if( _tcscmp(pstrName, _T("thumbnormalimage")) == 0 ) {SetThumbNormalImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("thumbhotimage")) == 0 ) {SetThumbHotImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("thumbpushedimage")) == 0 ) {SetThumbPushedImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("thumbdisabledimage")) == 0 ) {SetThumbDisabledImage(pstrValue);return ;}
		break;
	case 'h':
		if( _tcscmp(pstrName, _T("hor")) == 0 ) {SetHorizontal(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	case 'l':
		if( _tcscmp(pstrName, _T("linesize")) == 0 ) {SetLineSize(_ttoi(pstrValue));return ;}
		break;
	case 'r':
		if( _tcscmp(pstrName, _T("railnormalimage")) == 0 ) {SetRailNormalImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("railhotimage")) == 0 ) {SetRailHotImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("railpushedimage")) == 0 ) {SetRailPushedImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("raildisabledimage")) == 0 ) {SetRailDisabledImage(pstrValue);return ;}
		else if( _tcscmp(pstrName, _T("range")) == 0 ) {SetScrollRange(_ttoi(pstrValue));return ;}
		break;
	case 'v':
		if( _tcscmp(pstrName, _T("value")) == 0 ) {SetScrollPos(_ttoi(pstrValue));return ;}
		break;
	case 's':
		if( _tcscmp(pstrName, _T("showbutton1")) == 0 ) {SetShowButton1(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		else if( _tcscmp(pstrName, _T("showbutton2")) == 0 ) {SetShowButton2(_tcscmp(pstrValue, _T("true")) == 0);return ;}
		break;
	}
	CControlUI::SetAttribute(pstrName, pstrValue);
}
